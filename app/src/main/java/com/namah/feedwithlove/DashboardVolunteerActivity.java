...
import ui.volunteer.FragmentVolunteerHistory;
import ui.volunteer.FragmentVolunteerHome;
import ui.volunteer.FragmentVolunteerProfile;
...
public class DashboardVolunteerActivity extends AppCompatActivity {
        ...
        getOnBackPressedDispatcher().addCallback(this,
                new OnBackPressedCallback(true) {
                    ...
                    public void handleOnBackPressed() {
                        ...
                        Toast.makeText(
                                DashboardVolunteerActivity.this,
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 2) {  // Profile Fragment
                    bottomBar.setBarBackgroundColor(
                            ContextCompat.getColor(DashboardVolunteerActivity.this, R.color.white)
                    );
                } else {
                    bottomBar.setBarBackgroundColor(
                            ContextCompat.getColor(DashboardVolunteerActivity.this, R.color.love_bg_warm)
                    );
                }
            }
        });
    ...
    private static class DashboardPagerAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            switch (position) {
                case 0:
                    return new FragmentVolunteerHome();
                case 1:
                    return new FragmentVolunteerHistory();
                case 2:
                    return new FragmentVolunteerProfile();
                default:
                    return new FragmentVolunteerHome();
            }
        }
