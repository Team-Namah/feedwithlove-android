...
import ui.receiver.FragmentReceiverHistory;
import ui.receiver.FragmentReceiverHome;
import ui.receiver.FragmentReceiverProfile;

public class DashboardReceiverActivity extends AppCompatActivity {
        ...
        getOnBackPressedDispatcher().addCallback(this,
                new OnBackPressedCallback(true) {
                    ...
                    public void handleOnBackPressed() {
                        ...
                        Toast.makeText(
                                DashboardReceiverActivity.this,
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 2) {  // Profile Fragment
                    bottomBar.setBarBackgroundColor(
                            ContextCompat.getColor(DashboardReceiverActivity.this, R.color.white)
                    );
                } else {
                    bottomBar.setBarBackgroundColor(
                            ContextCompat.getColor(DashboardReceiverActivity.this, R.color.love_bg_warm)
                    );
                }
            }
        });
    ...
    private static class DashboardPagerAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            switch (position) {
                case 0:
                    return new FragmentReceiverHome();
                case 1:
                    return new FragmentReceiverHistory();
                case 2:
                    return new FragmentReceiverProfile();
                default:
